// Attempt 3: Everything from attempt 2, plus:
//   8. Share log(jN) between t and ac computations
//   9. Hoist log(chroma * tIC) out of Newton loop (loop-invariant)
//   Saves 1 log() per Newton iteration = 5 log() calls total (10% fewer transcendentals)
