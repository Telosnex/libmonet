...
void main() {
  group('#334157', () {
    test('light mode', () {
      ...
      expect(colors.colorHoverText, isColor(0xffD4E2FE));
      expect(colors.colorSplash, isColor(0xff808EA8));
      expect(colors.colorSplashText, isColor(0xffF5F6FF));
      ...
      expect(colors.fillHoverText, isColor(0xffD4E2FE));
      expect(colors.fillSplash, isColor(0xff808EA8));
      expect(colors.fillSplashText, isColor(0xffF5F6FF));
      expect(colors.text, isColor(0xff7B89A2));
      expect(colors.textHover, isColor(0xffC2D0EC));
      expect(colors.textHoverText, isColor(0xff39475E));
    ...
    test('dark mode', () {
      ...
      expect(colors.fillHover, isColor(0xffAAB8D3));
      expect(colors.fillHoverText, isColor(0xff142337));
      expect(colors.fillSplash, isColor(0xffC2D0EC));
      expect(colors.fillSplashText, isColor(0xff39475E));
      expect(colors.text, isColor(0xffA4B2CD));
      expect(colors.textHover, isColor(0xff5B6981));
      expect(colors.textHoverText, isColor(0xffCEDCF8));
      expect(colors.textSplash, isColor(0xff8290AA));
      expect(colors.textSplashText, isColor(0xffF6F8FF));
    });
  });
