...
class PaletteSnapshot extends Palette {
  ...
  PaletteSnapshot._({
    ...
    required this._backgroundText,
    required this._backgroundFill,
    required this._backgroundBorder,
    required this._backgroundHovered,
    required this._backgroundSplashed,
    required this._backgroundHoveredFill,
    required this._backgroundSplashedFill,
    required this._backgroundHoveredText,
    required this._backgroundSplashedText,
    required this._backgroundHoveredBorder,
    required this._backgroundSplashedBorder,
    required this._fill,
    required this._fillBorder,
    required this._fillHovered,
    required this._fillSplashed,
    required this._fillText,
    required this._fillHoveredText,
    required this._fillSplashedText,
    required this._fillIcon,
    required this._fillHoveredBorder,
    required this._fillSplashedBorder,
    required this._color,
    required this._colorText,
    required this._colorIcon,
    required this._colorBorder,
    required this._colorHovered,
    required this._colorHoveredText,
    required this._colorHoveredBorder,
    required this._colorSplashed,
    required this._colorSplashedText,
    required this._colorSplashedBorder,
    required this._text,
    required this._textHovered,
    required this._textHoveredText,
    required this._textSplashed,
    required this._textSplashedText,
